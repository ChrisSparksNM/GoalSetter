            ...
            <div class="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-3">
                            <form method="POST" action="{{ route('verification.send.login') }}" class="inline">
                                @csrf
                                <input type="hidden" name="email" value="{{ old('email') }}">
                                <button type="submit" class="bg-yellow-50 text-yellow-800 font-medium py-2 px-3 rounded-md text-sm hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 border border-yellow-300">
